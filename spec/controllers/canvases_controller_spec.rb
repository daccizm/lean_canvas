  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved canvas as @canvas" do
        ...
        post :create, {:canvas => { "title" => "invalid value" }}, valid_session
        assigns(:canvas).should be_a_new(Canvas)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested canvas" do
        ...
        Canvas.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => canvas.to_param, :canvas => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the canvas as @canvas" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Canvas.any_instance.stub(:save).and_return(false)
        put :update, {:id => canvas.to_param, :canvas => { "title" => "invalid value" }}, valid_session
        assigns(:canvas).should eq(canvas)
      end
